          ...
          <Section>
            <ContactItem>
                <IconBox className="IconBox"/>
                  <IconItem><ion-icon style={iconStyle} name="call"></ion-icon></IconItem>
              <ContactWrap>
                <h1>Call Us</h1>
                <p>+ 63 8527 0972</p>
            ...
            <ContactItem>
                <IconBox/>
                  <IconItem><ion-icon style={iconStyle} name="location-sharp"></ion-icon></IconItem>
              <ContactWrap>
                <h1>Visit Us</h1>
                <p>Manila City Hall<br/>Padre Burgos Avenue<br/>Ermita, Manila 1000</p>
                <img src={ whiteline } alt="white line"/>
              </ContactWrap>
            </ContactItem>
            <ContactItem>
                <IconBox/>
                  <IconItem><ion-icon style={iconStyle} name="business"></ion-icon></IconItem>
              <ContactWrap>
                <h1>Office Hours</h1>
